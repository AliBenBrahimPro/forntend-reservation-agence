...
const ListreservationProgrammeuser = () => {
...
console.log(getAllData)
      ...
      getActions: ( params ) => 
           ...
           [
            <GridActionsCellItem
              ...
              onClick={() =>{navigate(`/agence/listuserclientreservationevent/${params.id}`)}}
            />,
            <GridActionsCellItem
              icon={<EditIcon />}
              label="Edit"
              onClick={() =>{navigate(`/agence/updatereservationevenement/${params.id}`)}}
            />,
            <GridActionsCellItem
              icon={<DeleteIcon />}
              label="Delete"
 ...
 <Header title="List des Programmes" subtitle="Bienvenue a ton liste des reservations des programmes" />
</Box>
<Box
 m="8px 0 0 0"
 width="100%"
...
export default ListreservationProgrammeuser;
