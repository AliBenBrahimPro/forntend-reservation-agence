...
import {fetchclientReservationhotel} from '../../redux/reservationhotelSlice'
import Header from "../../components/Header";
import { useNavigate } from 'react-router-dom';
import { useParams } from 'react-router-dom';

const ClientReserveruserHotel = () => {
    const {id} = useParams();
...
const dispatch = useDispatch();
    ...
    useEffect(()=>{
      dispatch(fetchclientReservationhotel(id))
...
export default ClientReserveruserHotel;
